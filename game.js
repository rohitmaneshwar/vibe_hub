// HIGH QUALITY 50 UNIQUE DATASET 
const localPuzzles = {
    1: [
        ...
        { cat: "Nature", q: "हमारे सौरमंडल का सबसे बड़ा ग्रह ______ है और सबसे छोटा ग्रह ______ है।", opts: ["बृहस्पति / बुध", "शनि / मंगल", "पृथ्वी / शुक्र", "बृहस्पति / बुध"], a: "बृहस्पति / बुध" }
    ],
    2: [
    ...
    4: [
        ...
        { cat: "GK", q: "भारत के प्रथम प्रधानमंत्री ______ थे और प्रथम राष्ट्रपति ______ थे।", opts: ["जवाहरलाल नेहरू / डॉ. राजेंद्र担当", "महात्मा गांधी / नेहरू", "सरदार पटेल / कलाम", "जवाहरलाल नेहरू / डॉ. राजेंद्र प्रसाद"], a: "जवाहरलाल नेहरू / डॉ. राजेंद्र प्रसाद" },
    ...
    5: [
        ...
        { cat: "Reasoning", q: "यदि car का संबंध ______ से है, तो हवाई जहाज का संबंध ______ से है।", opts: ["रोड / आसमान", "पेट्रोल / पायलट", "पहिए / पंख", "ड्राइवर / रनवे"], a: "रोड / आसमान" },
    ...
    9: [
        ...
        { cat: "GK", q: "Gate of India ______ में है और 'इंडिया गेट' ______ शहर में स्थित है।", opts: ["मुंबई / दिल्ली", "दिल्ली / मुंबई", "मुंबई / कोलकाता", "चेन्नई / दिल्ली"], a: "मुंबई / दिल्ली" },
...
function loadLevelQuest() {
    ...
    lvlDisplay.innerText = `LVL ${currentLvl}`;
